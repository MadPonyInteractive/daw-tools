...
class ViewportScene(QGraphicsScene):
...
class Viewport(QGraphicsView):
    def __init__(self, grid=None):
        ...
        self.setScene(ViewportScene(grid))
        self.setBackground()
...
if __name__ == '__main__':
    ...
    vp = Viewport(main_grid)

    print(vp.grid())
    # vp.setFixedSize(900,900)# PySide6 QGraphicsView methods are available
    ...
    vp.setRowHeight(50)
    vp.addRow(QColor(100,100,100))
    vp.addRow(QColor(80,80,80))
    vp.addRow(QColor(100,100,100))
    vp.addRow(QColor(80,80,80))
    vp.addRow(QColor(100,100,100))
    vp.addRow(QColor(80,80,80))
    ...
    vp.addColumn(col_id='Track 1',pos=0,width=200,opacity=1)

    # Add/Remove/Set Columns test
    # vp.addColumn(col_id,pos,width,opacity)
    QTimer.singleShot(500,lambda: vp.addColumn(col_id='Track 2',pos=300,width=200,opacity=1))
    # vp.setColumn(col_id,pos,width,opacity)
    QTimer.singleShot(1000,lambda: vp.setColumn(col_id='Track 1',opacity=.2))
    # vp.removeColumn(col_id)
    QTimer.singleShot(2500,lambda: vp.removeColumn('Track 1'))


    # Add/Move/Remove Rows Test
    QTimer.singleShot(1000,lambda: vp.addRow(QColor(100,0,0),6))
    QTimer.singleShot(2000,lambda: vp.moveRow(6,2))
    QTimer.singleShot(3000,lambda: vp.removeRow(2))
